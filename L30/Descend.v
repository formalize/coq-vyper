...
From Vyper.L30 Require Import AST Callset.
...
exact (proj2 (Nat.ltb_lt _ _)
         (call_descend (proj1 (Nat.ltb_lt _ _) (fun_bound_ok fc))
                       ...
                       (fun_depth_ok fc) ss CallOk Ebound 
                       E Edepth)).
Qed.
